...
const PropertyStats: React.FC<PropertyStatsProps> = ({ bedrooms, bathrooms, area }) => {
  return (
    <div className="grid grid-cols-3 gap-6 mb-8">
      <div className="text-center p-4 bg-white dark:bg-slate-700 rounded-xl shadow-md border border-gray-100 dark:border-slate-600">
        <div className="flex items-center justify-center mb-2">
          ...
          <span className="text-2xl font-bold text-gray-900 dark:text-white">{bedrooms}</span>
        </div>
      ...
      <div className="text-center p-4 bg-white dark:bg-slate-700 rounded-xl shadow-md border border-gray-100 dark:border-slate-600">
        <div className="flex items-center justify-center mb-2">
          ...
          <span className="text-2xl font-bold text-gray-900 dark:text-white">{bathrooms}</span>
        </div>
      ...
      <div className="text-center p-4 bg-white dark:bg-slate-700 rounded-xl shadow-md border border-gray-100 dark:border-slate-600">
        <div className="flex items-center justify-center mb-2">
          ...
          <span className="text-2xl font-bold text-gray-900 dark:text-white">{area}m²</span>
        </div>
